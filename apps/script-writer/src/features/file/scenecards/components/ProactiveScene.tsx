...
const ProactiveScene = ({ formData, setFormData, setFile, setPreviewURL, previewURL }: any) => {
...
function PhotoUpload({ data, setData, setFile, setPreviewURL, previewURL }: any) {
  ...
  return (
    <section className="py-4 border-b border-slate-300 h-auto w-[100%]">
