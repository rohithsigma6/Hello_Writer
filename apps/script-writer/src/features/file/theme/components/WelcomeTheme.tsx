...
const WelcomeTheme = ({ setThemeStatus }: any) => {
  return (
      ...
      <div className="bg-white rounded-[24px] px-[32px] pt-[40px] font-poppins ">
        <div className="flex xl:flex-row flex-col gap-6 items-start">
          ...
          <div className="xl:hidden">
            <img
              src={themeData?.smIcon}
              loading="lazy"
              className="mx-auto object-contain"
            />
          </div>
          <div className="flex flex-col" key={themeData.tipsHeading}>
            <section>
            ...
            <section className="gap-y-3">
              <button
                ...
                onClick={() => setThemeStatus('initialize')}
              >
                {themeData.btnText}
              </button>
            </section>
