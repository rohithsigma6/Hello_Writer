  ...
  content: [
    ...
    },
    {
      ...
      content: [
        {
          type: 'text',
          text: 'import { Editor } from "@screenplay-ink/editor";\n\nexport default function App() {\n  return (\n     <Editor />\n  )\n}',
        },
      ],
    },
    {
...
interface TransliterationLanguage {
  label: string;
  value: string;
}

const transliterationLanguageData: TransliterationLanguage[] = [
  {
    label: 'English',
    value: 'en',
  },
...
export { transliterationLanguageData };
