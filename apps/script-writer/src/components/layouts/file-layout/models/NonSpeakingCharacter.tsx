...
function NonSpeakingCharacter({ isOpen, onClose }:any) {
     ...
     <Modal className="bg-white rounded-[24px] shadow-md w-[560px]" isOpen={isOpen}>
        <form action="">
            <div className="flex justify-between pl-[40px] pr-[24px] py-[24px] items-center] border-b border-b-[#00000036]">
              <h2 className="text-xl">Insert Non-Speaking Character</h2>
            ...
            <div className="flex justify-end py-[12px] border-t border-t-[#00000036] pr-[24px]">
              <button
                type="reset"
                className="rounded-[16px] min-w-[160px] text-[#6A6A75] font-medium py-[18px] px-[52px] text-[16px] border border-[#9999A0] max-w-[160px] font-poppins mr-2 ' disabled:text-gray-500 disabled:hover:bg-none'"
                onClick={onClose}>
                Cancel
              </button>
              <button
...
export default NonSpeakingCharacter